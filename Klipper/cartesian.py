...
class CartKinematics:
    def __init__(self, toolhead, config, motion_contr = False):
        ...
        for rail, axis in zip(self.rails, 'xyz'):
            rail.setup_itersolve('cartesian_stepper_alloc', motion_contr, axis)
        ...
        if config.has_section('dual_carriage'):
            ...
            dc_rail.setup_itersolve('cartesian_stepper_alloc', motion_contr dc_axis)
